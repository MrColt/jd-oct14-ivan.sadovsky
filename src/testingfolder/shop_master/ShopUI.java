...
public class ShopUI {
	...
	private JPanel createPanel() {
		...
		tf = new JTextField();
		tf.setColumns(10);
		panel.add(tf, new GridBagConstraints(2, 0, 1, 1, 0, 0,
		...
		JLabel label1 = new JLabel(
				"Please, choose one of the books and it's required quantity");
		...
		button1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				bookshop.buy(customer, indexOfRButton,
